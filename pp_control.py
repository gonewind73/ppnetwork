...
class Block(object):
    ...
    def get_md5(self, start=0, end=0):
        ...
        for i in range(0, int((realend - start) / 1024)):
...
#         peer.beat_interval = 1
    ...
    def beat_null(self):
        ...
        logging.debug("beat null")   
        
    def send_offline(self):
        beat_dictdata = {"beat_cmd":_BEAT_CMD["offline"]}
        beat_dictdata["node"] = self.station.beat_info()
...
class NetManage(PPNetApp):
    ...
    tags_string = {
      1:"stat_req",2:"stat_res",3:"stat_set",
      0x10:"node_id",0x11:"os",0x12:"nodes",0x13:"files"}
    ...
    class NMMessage(PPApp.AppMessage):
        ...
        def __init__(self, **kwargs):
            ...
            super().__init__(app_id=PP_APPID["NetManage"],
                             tags_id=NetManage.tags_id,
                             tags_string=NetManage.tags_string,
                             parameter_type=parameter_type,
                             **kwargs)
    ...
    def process_stat_res(self,parameters):
        ...
        if node_id in self.callback_list:
            ...
            self.waiting_list[node_id] = parameters
        pass   
...
class PPStation(PPLinker):
    ...
    def start(self):
        super().start()
        logging.info("Station is runing!")
        return self        
...
class FakeAppNet(PPStation):
    ...
    def __init__(self, node_id=0):
        super().__init__(config={"node_id":node_id, "node_ip":"118.153.152.193", "node_port":54330, "nat_type":NAT_TYPE["Turnable"]})
